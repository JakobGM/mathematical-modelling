...
Under the assumption that the dominating body force is $f_g$ \red{(again, this needs to be argued for better. are there other body forces?),}, equation~\eqref{eq:steady-state-unknown-force} becomes:
